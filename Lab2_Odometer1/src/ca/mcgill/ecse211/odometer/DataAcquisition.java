...
/**
 * We used this class to test our sensor We started the robot in a straight line
 * and printed the sensor values We copied them and used that to find our
...
public class DataAcquisition implements TimerListener {
	...
	public static final int NSAMPLES = 150; // Number of samples to acquire
	public static final int TIMEOUT = 40000; // Fail if no comms by this time (mS)
	public static final int FWDSPEED = 250; // Forward motion speed (deg/sec)
